	nios_system u0 (
		.block_data_export      (<connected-to-block_data_export>),      //      block_data.export
		.clk_clk                (<connected-to-clk_clk>),                //             clk.clk
		.drawing_status_export  (<connected-to-drawing_status_export>),  //  drawing_status.export
		...
		.random_seed_export     (<connected-to-random_seed_export>),     //     random_seed.export
		...
		.level_score_export     (<connected-to-level_score_export>)      //     level_score.export
	);
